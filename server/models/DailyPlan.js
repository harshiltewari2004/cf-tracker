...
const dailyPlanSchema = new mongoose.Schema(
  {
    ...
    planType: { type: String, enum: ['cold_start', 'gap_driven'], required: true },
    problems: [
      {
    ...
    replacedProblems: [
      {
        original: { type: mongoose.Schema.Types.ObjectId, ref: 'Problem', required: true },
        replacement: { type: mongoose.Schema.Types.ObjectId, ref: 'Problem', required: true },
