...
const contestProblemResultSchema = new mongoose.Schema(
    {
        ...
        contestResult:{type:mongoose.Schema.Types.ObjectId,ref:'ContestResult',required:true},
...
contestProblemResultSchema.index({user:1,cfContestId:1,problemIndex:1},{unique:true});

export default mongoose.model('ContestProblemResult',contestProblemResultSchema);